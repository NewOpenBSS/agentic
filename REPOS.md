...
This file is the authoritative list of all repositories that make up the
NewOpenBSS solution. Each entry is an independently deployable monorepo with its
